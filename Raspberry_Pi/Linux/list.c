...
#include <string.h>
#include <fcntl.h>
#include <dirent.h> 		/* Headerfile for directory control function */
#include <pwd.h> 		/* getpwuid( ) : Get the name of user using uid */
#include <grp.h> 		/* getgrgid( ) : Get the name of group using gid*/
#include <time.h> 		/* localtime( ) */
#include <sys/stat.h>
#include <sys/types.h>

// application doing ls -Rl or ls -l command
int listDir(char *arg)
{
    DIR *pdir; 			/* Stream for control of directory */
    struct dirent *dirt; 	/* Struct for list of directory */
    struct stat statBuf; 	/* Struct for information of file*/
